...
export declare class StreamChat<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> {
    ...
    */
     ...
     * @return {Segment} The created Segment
     */
    createUserSegment(id: string, name: string, data?: SegmentData): Promise<Segment>;
    /**
     ...
     * @return {Segment} The created Segment
     */
    createChannelSegment(id: string, name: string, data?: SegmentData): Promise<Segment>;
    /**
     ...
     */
    updateSegment(id: string, data: Partial<UpdateSegmentData>): Promise<Segment>;
    /**
     ...
     * @return {APIResponse} API response
     */
    deleteSegmentTargets(id: string, targets: string[]): Promise<APIResponse>;
    /**
     ...
     */
    querySegments(filter: {}, options?: QuerySegmentsOptions): Promise<{
        segments: Segment[];
    }>;
    /**
